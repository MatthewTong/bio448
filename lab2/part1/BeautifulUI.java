...
public class BeautifulUI extends javax.swing.JFrame {
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        if (windowSize <= 0) {
            windowSize = 100;
            console.append("Adjusted Window Size to 100 due to it having an invalid value\n");
        }
        
        if (stepSize <= 0) {
            stepSize = 100;
            console.append("Adjusted Step Size to 100 due to it having an invalid value\n");
        }
